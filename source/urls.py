...
urlpatterns = [
    ...
    path('reestablecer_contrasena/', 
        ...
        name='password_reset'),
    path('reestablecer_contrasena/enviada', 
        auth_views.PasswordResetDoneView.as_view(template_name='login/password_done.html'), 
        name='password_reset_done'),
    path('reestablecer_contrasena_confirmacion/<uidb64>/<token>', 
        auth_views.PasswordResetConfirmView.as_view(template_name='login/password_confirm.html'), 
        name='password_reset_confirm'),
    path('reestablecer_contrasena_completado/', 
        auth_views.PasswordResetCompleteView.as_view(template_name='login/password_complete.html'), 
